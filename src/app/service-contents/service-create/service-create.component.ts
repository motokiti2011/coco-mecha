...
import { ModalData, nextActionButtonTypeMap } from '../../entity/nextActionButtonType';
import {
  find as _find,
  filter as _filter,
  isNil as _isNil,
...
import { monthMap } from '../../entity/month';
import { nextActionButtonType, nextActionMessageType, nextActionTitleType } from '../../entity/nextActionButtonType';
...
export class ServiceCreateComponent implements OnInit {
  ...
  getResult() {
    ...
    this.service.servicePost(this.service.converSlipDetail(this.inputData)).subscribe(result => {
      // 登録結果からメッセージを表示する
      if (result === 200) {
        this.next();
      }
