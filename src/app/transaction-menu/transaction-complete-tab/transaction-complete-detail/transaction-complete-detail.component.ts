...
@Component({
  selector: 'app-transaction-complete-detail',
  templateUrl: './transaction-complete-detail.component.html',
  styleUrls: ['./transaction-complete-detail.component.scss']
})
export class TransactionCompleteDetailComponent implements OnInit {
